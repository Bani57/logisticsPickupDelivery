...
/**
 * Implementation of an auction agent that uses most of the techniques from the
 * main agent. Differs in that it does not utilize information about the future
 * and estimates the opponent's bid lower bound only using the very conservative
 * and crude objective value. Computation of optimal plans during each bid price
 * computation and the final solution based on our implementation of the SLS
 * algorithm for the centralized exercise.
 *
 * @author Andrej Janchevski
 * @author Orazio Rillo
 */
@SuppressWarnings("unused")
public class AuctionAgentConservative implements AuctionBehavior {
	...
	public Long askPrice(Task task) {
		...
		Double opponentBidLowerBound = marginalCostOpponent;
